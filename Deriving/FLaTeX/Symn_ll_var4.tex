...
\renewcommand{\invariant}{
  \FlaTwoByOne{A_{TL} B_T + A_{BL}^T B_B + C_T = \widehat C_T}
...
\renewcommand{\beforeupdate}{
  \FlaThreeByOneB{A_{00} B_0 + a_{10} b_1^T + A_{20}^T B_2 + C_0 = \widehat C_0}
...
\renewcommand{\afterupdate}{
  \FlaThreeByOneT{A_{00} B_0 + a_{10} b_1^T + A_{20}^2 B_2 +  C_0 = \widehat C_0}
                 {a_{10}^T B_0 + \alpha_{11} b_1^T + a_{21}^T B_2 +  c_1^T = \widehat c_1^T}
                 {A_{20} B_0 + b_{21} b_1^T + C_2 = \widehat C_2}
}
